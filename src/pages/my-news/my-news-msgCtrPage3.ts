...
@Component({
  selector: 'page-my-news-msgCtrPage3',
  templateUrl: 'my-news-msgCtrPage3.html'
})
export class MyNewsMsgCtrPage3 {
  ...
  constructor(public navCtrl: NavController,
    ...
    this.detailArticleInfo = this.userContext.getMessageCenterInfo()["article3"];
