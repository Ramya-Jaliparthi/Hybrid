...
import { FadSearchListComponentInputModelInterface, SortInterface } from '../modals/interfaces/fad-search-list.interface';
import { FadVitalsProfessionalsSearchResponseModelInterface } from '../modals/interfaces/fad-vitals-collection.interface';
import {
  GetSearchByProfessionalResponseModelInterface, Facets,
  ...
  TechSavvyInterface, InNetworkInterface, TreatmentMethodsTypeCodeInterface, DisordersTreatedTypeCodeInterface
...
import {
  GetSearchByProfessionalRequestModel, FadProfessional,
  AcceptingNewPatients, TechSavvy, InNetwork
} from '../modals/getSearchByProfessional.model';
...
@Component({
  selector: 'page-fad-search-list',
  templateUrl: 'fad-search-list.html',
})
export class FadSearchListPage {
  ...
  public searchResponse: FadVitalsProfessionalsSearchResponseModelInterface;
  public professionalsList: FadProfessional[] = null;
  ...
  ionViewDidLoad() {
    console.log('ionViewDidLoad FadSearchListPage');
  }
  ...
  getProfileCardInput(professional: FadProfessional): FadProfileCardComponentInputModel {
