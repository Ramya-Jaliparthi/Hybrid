...
export class MsgCtrPage2 {
  ...
  constructor(private configProvider: ConfigProvider,
    ...
    if (this.userContext.getMessageCenterInfo() != null) {
      this.selectedArticle = this.userContext.getMessageCenterInfo()["article2"];
    } else {
